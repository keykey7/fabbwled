...
public class Section33 implements SectionHandler {
    ...
    public SectionNode getBody(PlayerDto current) {
        ...
        return SectionNode.root().text("""
                ...
                Sheet. You do not get a refund.""").activeIf(current.shards() >= 200 && isInitiate,x -> x.clickable( n -> n.subtractStamina(200).withResurrectionArrangement(new Resurrection("Temple of Tyrnai, The War-Torn Kingdom 640",SectionId.book1(640))), c -> c.text("Resurrection costs 200 Shards if you are an initiate.").clickableTurnTo(282)))
